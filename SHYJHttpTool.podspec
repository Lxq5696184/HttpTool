...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "LXQ" => "1416417511@qq.com" }
  # Or just: spec.author    = "LXQ"
  # spec.authors            = { "LXQ" => "1416417511@qq.com" }
  # spec.social_media_url   = "https://twitter.com/LXQ"
  ...
  spec.source_files  = "SHYJHttpTool", "SHYJHttpTool/**/*.{h,m}","SHYJHttpTool/**/**/*.{h,m}"
